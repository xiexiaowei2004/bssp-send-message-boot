 ...
 */
@TableName("inv_exg")
public class InvExg implements Serializable {
     ...
     * 归类标记
     */
	@TableField("CLY_MARKNAME")
	private String clyMarkname;
    /**
     * 企业内部清单编号
     */
	...
	public String getClyMarkname() {
		return clyMarkname;
	}

	public void setClyMarkname(String clyMarkname) {
		this.clyMarkname = clyMarkname;
	}
