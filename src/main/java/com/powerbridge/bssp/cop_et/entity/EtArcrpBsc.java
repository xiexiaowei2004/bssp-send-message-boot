 ...
 * @since 2017-05-22
 */
@TableName("et_arcrp_bsc")
public class EtArcrpBsc implements Serializable {

    @TableField(exist = false)
    private static final long serialVersionUID = -8480932886280386033L;
    /**
     * 主键
     */
    @TableId("UID")
     ...
     * 经营单位社会信用代码
     */
    @NotNull(message = "经营单位社会信用代码不能为空")
    @TableField("BIZOP_ETPS_SCCD")
    private String bizopEtpsSccd;
    /**
     * 经营单位代码
     */
    @NotNull(message = "经营单位代码不能为空")
     ...
     * 加工单位社会信用代码
     */
    @NotNull(message = "加工单位社会信用代码不能为空")
    @TableField("PRCS_ETPS_SCCD")
    private String prcsEtpsSccd;
    /**
     * 加工单位代码
     */
    @NotNull(message = "加工单位代码不能为空")
     ...
     * 申报单位社会信用代码
     */
    @NotNull(message = "申报单位社会信用代码不能为空")
    @TableField("DCL_ETPS_SCCD")
    private String dclEtpsSccd;
    /**
     * 申报单位代码
     */
    @NotNull(message = "申报单位代码不能为空")
