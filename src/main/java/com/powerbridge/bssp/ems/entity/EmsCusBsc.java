 ...
 * @since 2017-06-02
 */
@TableName("ems_cus_bsc")
public class EmsCusBsc implements Serializable {
	...
	public void stAreaName(String areaName) {
	...
	public void decTimeStart(String decTimeStart) {
	...
	public void decTimeEnd(String decTimeEnd) {
		this.decTimeEnd = decTimeEnd;
	}

	public String getEmsTypenm(){return emsTypenm;}
